...
<Menu>
  ...
  <MenuList className='list3'>
    ...
    <MenuItem>
    <Image w={"250px"} h={"250px"} src="https://www.beautybebo.com/pub/media/mega-menu/ayurveda_cata.jpg" />
    </MenuItem>
    
  </MenuList>
</Menu>
{/* <Menu>
  <MenuButton  color={"white"} bg="#DD0285" as={Button} rightIcon={<ChevronDownIcon />}>
    BRANDS
  </MenuButton>
  <MenuList>
