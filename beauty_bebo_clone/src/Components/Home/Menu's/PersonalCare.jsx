...
export default function PersonalCareMenu({ children,data }) {
  ...
  return (
      ...
      >
        ...
        <MenuItem style={{ width: "40%",display:'flex',flexDirection:'column',gap:"7px",alignItems:"end" }}>
          <img style={{maxHeight:"450px"}} src={data.fourth} alt="menuImage" />
        </MenuItem>
      </MenuList>
    </Menu>
  );
